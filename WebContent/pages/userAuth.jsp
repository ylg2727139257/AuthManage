...
${USER==null?"<script>alert('亲 ， 还 未 登 录 哦 !');location.href='../pages/login.jsp';</script>":"" }
	...
	<div class="container-fluid" style="margin-top: 30px;">
		<div class="row">
			...
			<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
				<h1 class="page-header">修改用户<font color="red">${userCode1 }</font>权限</h1>
	...
	<script>
	 $("#cancel").click(function(){
		 location.href="${pageContext.request.contextPath}/user/list.action?pageNum="
	...
	$("#update-auth").click(function(){
    	...
    	location.href="${pageContext.request.contextPath}/user/updateUserAuth.action?pageNum="
			+ ${page.pageNum}+"&pageSize=" + ${page.pageSize} + "&authIdStr=" + v + "&userId="
			+ ${userId1}; 
	});
	</script>
</body>
